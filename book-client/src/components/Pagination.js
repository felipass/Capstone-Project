...
const Pagination = ({pages, setCurrentPage, currentBooks, bookList}) => {
    ...
    return (
        ...
        <div className="hint-text">Showing <b>{currentBooks.length}</b> out of <b>{bookList.length}</b> entries</div>
